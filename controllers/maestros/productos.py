...
def get_productos():
    ...
    try:
        ...
        cur.execute("SELECT p.id_producto AS id, p.nombre, p.idRamo AS ramo_id, r.nombre AS ramo_nombre FROM productos p JOIN ramos r ON r.idRamo = p.idRamo ORDER BY r.nombre, p.nombre")
